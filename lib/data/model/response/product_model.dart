...
class Product {
  ...
  String _largeUnit;
  String _largeUnitParcode;
  double _largeUnitQuantity;
  int _largeUnitPrice;
  double _quantityFromPc;
  ...
  double get largeUnitQuantity => _largeUnitQuantity;

  int get largeUnitPrice => _largeUnitPrice;

  double get quantityFromPc => _quantityFromPc;
